"""Escrita de um pseudocódigo

Antes de executar o script Python, escreva a lógica do loop while em frases completas (sem código). Essa técnica é chamada de pseudocodificação.
